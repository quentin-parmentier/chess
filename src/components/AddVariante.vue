<template lang="">
    <div @click="() => this.$emit('enregistrer')" 
        class=" bg-gray-500 opacity-40 w-full h-full z-50 absolute top-0 left-0"></div>
    <div class="fixed min-w-max top-1/2 left-1/2 mt-n188 ml-n143 bg-white opacity-100 z-50 p-5 animate-pop"> 
        ...
        <div class="space-y-2">
            ...
            <div class="flex">
                <base-button label="Enregistrer" class=" text-center p-3" @click="() => this.type == 'ouvertures' ? recOuverture() : recFinales()" />
